    ...
    <section className="py-20">
      <footer className="px-4 divide-y">
        <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
          <div className="lg:w-8/12">
            ...
            >
              <div className="flex items-center justify-center w-10 h-10 rounded-md bg-pink-500">
            ...
            <p className="py-5 text-center lg:text-start">
              ...
              dolorum nam, nisi ipsam quae dolorem ea non recusandae officiis
              totam?
            </p>
          </div>
          <div className="grid grid-cols-2 text-sm gap-10 md:gap-0 lg:w-7/10 sm:grid-cols-3 lg:pl-20">
            ...
            <div className="space-y-3">
              <div className="uppercase dark:text-gray-50">Newsletter</div>
              ...
              <div className="flex">
                <input
                  ...
                  className="flex flex-1 p-1 border sm:text-sm rounded-l-md focus:ri dark:border-gray-700 dark:text-gray-100 dark:bg-gray-800 focus:ri h-10 w-full md:w-11/12"
                />
                <span className="flex items-center px-3 pointer-events-none sm:text-sm rounded-r-md  bg-indigo-500 h-10">
                  Subscribe
                </span>
              </div>
            </div>
        ...
        <div className="px-12 flex flex-col-reverse md:flex-row justify-center lg:justify-between">
          <div className="flex flex-col self-center text-sm text-center md:block lg:col-start-1 md:space-x-6">
            <span>©2024 All rights reserved</span>
          </div>
          <div className="flex justify-center py-4 space-x-4 lg:pt-0 lg:col-end-13">
				...
				<a rel="noopener noreferrer" href="#" title="Instagram" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-violet-400 dark:text-gray-900">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="currentColor" className="w-6 h-6 hover:scale-125 duration-150">
				...
				<a rel="noopener noreferrer" href="#" title="Pinterest" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-violet-400 dark:text-gray-900">
					<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-6 h-6 hover:scale-125 duration-150">
      ...
      <section className="">
        <div className="container flex flex-col justify-center p-4 mx-auto md:p-8">
          <p className="p-2 text-sm lg:text-lg font-medium tracki text-center uppercase">
            How it works
          </p>
          <h2 className="mb-6 md:mb-12 text-3xl md:text-4xl font-bold leadi text-center sm:text-5xl">
            Frequently Asked Questions
          </h2>
          <div className="space-y-4">
            <div className="space-y-4 text-sm md:text-lg">
              <details className="group">
                <summary className="flex items-center justify-between  rounded-lg bg-gray-50 p-4 cursor-pointer">
                  <h2 className="font-medium">
                    Lorem ipsum dolor sit ametiug consectetur adipisicing?
                  </h2>
